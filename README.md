...
| FR-02 | The system shall allow **Agenda Visualization** in day, week, and month views with color-coded time slots, including the option to open the event capture form.                                                                                                                           | High       |
| FR-03 | The system shall allow **Agenda Consultation** by applying filters on: therapist, room, date range, and event status.                                                                                                                                                                     | High       |
| FR-04 | The system shall allow **Event Editing** modifying the fields: event type, date, time, therapist, room, duration, and reason.                                                                                                                                                             | High       |
| FR-05 | The system shall allow **Event Cancellation** by updating the status to canceled in the agenda and requiring a cancellation reason.                                                                                                                                                       | High       |
| FR-06 | The system shall allow management of **Appointment Requests** through an inbox showing patient, event type, and requested date, with actions to accept, reject, or open the capture form to confirm a new event.                                                                          | High       |
| FR-07 | The system shall allow management of **Rescheduling Requests** through an inbox showing patient, event type, and proposed new date, with actions to accept, reject, or open the edit form to reassign the appointment.                                                                    | High       |
| FR-08 | The system shall allow **User Search** to autocomplete patient and therapist fields using name, ID, or phone number.                                                                                                                                                                      | Medium       |
| FR-09 | The system shall allow viewing a **Patient Summary** including: contact data, last 5 appointments, relevant notes, and a link to the full record.                                                                                                                                         | High       |
